...
Published: 2020-08-20T13:55:00.000+05:30
...
Description: 
      ...
      0px;">
      In the last contest, you were asked to find the last digit of a very large number. This time,
      you are asked to find the entirety of a much smaller number: your task is to find the first
      number taken to the power of second number. A brute force approach does work here.</div>
      </div>
      ...
      The only line of input contains two space-separated integers<span
      ...
      class="Apple-converted-space">&nbsp;</span><span class="tex-font-style-tt"
      style="font-family: &quot;courier new&quot;, monospace; font-size:
      15.399999618530273px;">k</span>, 1 &lt;=<span
      class="Apple-converted-space">&nbsp;</span><span class="tex-font-style-tt"
      style="font-family: &quot;courier new&quot;, monospace; font-size:
      15.399999618530273px;">n</span>,<span
      class="Apple-converted-space">&nbsp;</span><span class="tex-font-style-tt"
      style="font-family: &quot;courier new&quot;, monospace; font-size:
      15.399999618530273px;">k</span><span
      class="Apple-converted-space">&nbsp;</span>&lt;= 10.</div>
      </div>
      ...
      Output</div>
      <div style="font-size: 1em; line-height: 1.4em; margin-top: 1.5em; padding: 0px;">
      Output a single integer: the number<span
      ...
      class=&quot;MJX-TeXAtom-ORD&quot;&gt;&lt;mi&gt;k&lt;/mi&gt;&lt;/mrow&gt;&lt;/msup&gt;&lt;/math&gt;"
      ...
      STIXGeneral-Italic; font-size: 11.8776px; line-height: normal; margin: 0px; padding: 0px;
      position: static; transition: none 0s ease 0s; vertical-align:
      0px;">𝑘</span></span></span><span style="border: 0px; box-sizing:
      ...
      xmlns="http://www.w3.org/1998/Math/MathML"><msup><mi>n</mi><mrow
      class="MJX-TeXAtom-ORD"><mi>k</mi></mrow></msup></math></span></span>.</div>
      </div>
      ...
      input<div class="input-output-copier" data-clipboard-target="#id008694784820971181"
      id="id004079556527746796" style="border: 1px solid rgb(185, 185, 185); color: rgb(136, 136,
      ...
      <pre id="id008694784820971181" style="background-color: #efefef; color: #880000;
      ...
      solid; border-bottom-width: 1px; font-size: 1.3em; font-weight: bold; margin: 0px; padding:
      0.25em; text-transform: lowercase;">
      output<div class="input-output-copier" data-clipboard-target="#id00385565714661099"
      id="id009143192360312186" style="border: 1px solid rgb(185, 185, 185); color: rgb(136, 136,
      136) !important; cursor: pointer; float: right; font-size: 1.2rem; line-height: 1.1rem;
      margin: 1px; padding: 3px; text-transform: none;" title="Copy">
      Copy</div>
      </div>
      <pre id="id00385565714661099" style="background-color: #efefef; color: #880000;
      font-family: Consolas, &quot;Lucida Console&quot;, &quot;Andale Mono&quot;,
      &quot;Bitstream Vera Sans Mono&quot;, &quot;Courier New&quot;, Courier;
      font-size: 12.6px; line-height: 1.25em; overflow-wrap: break-word; padding: 0.25em;
      white-space: pre-wrap;">243</pre>
      </div>
      </div>
      </div>
      </div>
      <script
      src="https://gist.github.com/Svastikkka/071d91ff6daf635e4200cfeb52b24d51.js"></script>
